...
object DesktopSingleInstance {
    ...
    fun claim(): Boolean {
        ...
        return try {
            val lockFile = DesktopPaths.appDir.resolve("mayak.lock").toFile()
    ...
    fun requestRestore(): Boolean {
        val lines = runCatching {
            Files.readAllLines(DesktopPaths.appDir.resolve("mayak.ipc"), StandardCharsets.UTF_8)
    ...
    fun close() {
        ...
        runCatching { Files.deleteIfExists(DesktopPaths.appDir.resolve("mayak.ipc")) }
        server = null
        lock = null
        lockChannel = null
        lockHandle = null
    ...
    private fun startServer() {
        ...
        val ipcFile = DesktopPaths.appDir.resolve("mayak.ipc")
        ...
        Thread({ listen(socket) }, "MayakSingleInstance").apply {
            isDaemon = true
            start()
        }
    }
